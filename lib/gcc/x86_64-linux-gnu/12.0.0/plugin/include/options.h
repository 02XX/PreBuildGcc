...
enum opt_code
{
  ...
  OPT_mandroid = 1775,                       /* -mandroid */
  OPT_march_ = 1776,                         /* -march= */
  OPT_masm_ = 1777,                          /* -masm= */
  OPT_mavx = 1778,                           /* -mavx */
  OPT_mavx2 = 1779,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1780,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1781,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1782,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1783,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1784,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1785,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1786,                      /* -mavx512bw */
  OPT_mavx512cd = 1787,                      /* -mavx512cd */
  OPT_mavx512dq = 1788,                      /* -mavx512dq */
  OPT_mavx512er = 1789,                      /* -mavx512er */
  OPT_mavx512f = 1790,                       /* -mavx512f */
  OPT_mavx512fp16 = 1791,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1792,                    /* -mavx512ifma */
  OPT_mavx512pf = 1793,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1794,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1795,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1796,                      /* -mavx512vl */
  OPT_mavx512vnni = 1797,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1798,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1799,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1800,                       /* -mavxvnni */
  OPT_mbionic = 1801,                        /* -mbionic */
  OPT_mbmi = 1802,                           /* -mbmi */
  ...
  OPT_mglibc = 1836,                         /* -mglibc */
  OPT_mhard_float = 1837,                    /* -mhard-float */
  OPT_mharden_sls_ = 1838,                   /* -mharden-sls= */
  OPT_mhle = 1839,                           /* -mhle */
  OPT_mhreset = 1840,                        /* -mhreset */
  OPT_miamcu = 1841,                         /* -miamcu */
  OPT_mieee_fp = 1842,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1843,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1844,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1845,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1846,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1847,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1848,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1849,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1850, */            /* -mintel-syntax */
  OPT_mkl = 1851,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1852,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1853,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1854,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1855,                /* -mlong-double-80 */
  OPT_mlwp = 1856,                           /* -mlwp */
  OPT_mlzcnt = 1857,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1858,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1859,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1860,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1861,                  /* -mmitigate-rop */
  OPT_mmmx = 1862,                           /* -mmmx */
  OPT_mmovbe = 1863,                         /* -mmovbe */
  OPT_mmovdir64b = 1864,                     /* -mmovdir64b */
  OPT_mmovdiri = 1865,                       /* -mmovdiri */
  OPT_mmove_max_ = 1866,                     /* -mmove-max= */
  OPT_mmpx = 1867,                           /* -mmpx */
  OPT_mms_bitfields = 1868,                  /* -mms-bitfields */
  OPT_mmusl = 1869,                          /* -mmusl */
  OPT_mmwait = 1870,                         /* -mmwait */
  OPT_mmwaitx = 1871,                        /* -mmwaitx */
  OPT_mneeded = 1872,                        /* -mneeded */
  OPT_mno_align_stringops = 1873,            /* -mno-align-stringops */
  OPT_mno_default = 1874,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1875,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1876,                  /* -mno-push-args */
  OPT_mno_red_zone = 1877,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1878,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1879,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1880,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1881,                          /* -mpc32 */
  OPT_mpc64 = 1882,                          /* -mpc64 */
  OPT_mpc80 = 1883,                          /* -mpc80 */
  OPT_mpclmul = 1884,                        /* -mpclmul */
  OPT_mpcommit = 1885,                       /* -mpcommit */
  OPT_mpconfig = 1886,                       /* -mpconfig */
  OPT_mpku = 1887,                           /* -mpku */
  OPT_mpopcnt = 1888,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1889, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1890,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1891,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1892,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1893,                        /* -mprfchw */
  OPT_mptwrite = 1894,                       /* -mptwrite */
  OPT_mpush_args = 1895,                     /* -mpush-args */
  OPT_mrdpid = 1896,                         /* -mrdpid */
  OPT_mrdrnd = 1897,                         /* -mrdrnd */
  OPT_mrdseed = 1898,                        /* -mrdseed */
  OPT_mrecip = 1899,                         /* -mrecip */
  OPT_mrecip_ = 1900,                        /* -mrecip= */
  OPT_mrecord_mcount = 1901,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1902,                 /* -mrecord-return */
  OPT_mred_zone = 1903,                      /* -mred-zone */
  OPT_mregparm_ = 1904,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 1905,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 1906,                           /* -mrtd */
  OPT_mrtm = 1907,                           /* -mrtm */
  OPT_msahf = 1908,                          /* -msahf */
  OPT_mserialize = 1909,                     /* -mserialize */
  OPT_msgx = 1910,                           /* -msgx */
  OPT_msha = 1911,                           /* -msha */
  OPT_mshstk = 1912,                         /* -mshstk */
  OPT_mskip_rax_setup = 1913,                /* -mskip-rax-setup */
  OPT_msoft_float = 1914,                    /* -msoft-float */
  OPT_msse = 1915,                           /* -msse */
  OPT_msse2 = 1916,                          /* -msse2 */
  OPT_msse2avx = 1917,                       /* -msse2avx */
  OPT_msse3 = 1918,                          /* -msse3 */
  OPT_msse4 = 1919,                          /* -msse4 */
  OPT_msse4_1 = 1920,                        /* -msse4.1 */
  OPT_msse4_2 = 1921,                        /* -msse4.2 */
  OPT_msse4a = 1922,                         /* -msse4a */
  /* OPT_msse5 = 1923, */                    /* -msse5 */
  OPT_msseregparm = 1924,                    /* -msseregparm */
  OPT_mssse3 = 1925,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1926,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1927, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1928,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1929, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1930,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1931,                  /* -mstackrealign */
  OPT_mstore_max_ = 1932,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 1933,            /* -mstringop-strategy= */
  OPT_mstv = 1934,                           /* -mstv */
  OPT_mtbm = 1935,                           /* -mtbm */
  OPT_mtls_dialect_ = 1936,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1937,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1938,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1939,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1940,                         /* -mtune= */
  OPT_muclibc = 1941,                        /* -muclibc */
  OPT_muintr = 1942,                         /* -muintr */
  OPT_mvaes = 1943,                          /* -mvaes */
  OPT_mveclibabi_ = 1944,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1945,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1946,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1947,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1948,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1949,                      /* -mwbnoinvd */
  OPT_mwidekl = 1950,                        /* -mwidekl */
  OPT_mx32 = 1951,                           /* -mx32 */
  OPT_mxop = 1952,                           /* -mxop */
  OPT_mxsave = 1953,                         /* -mxsave */
  OPT_mxsavec = 1954,                        /* -mxsavec */
  OPT_mxsaveopt = 1955,                      /* -mxsaveopt */
  OPT_mxsaves = 1956,                        /* -mxsaves */
  OPT_n = 1957,                              /* -n */
  OPT_name_sort = 1958,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1959,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1960,              /* -no-integrated-cpp */
  OPT_no_pie = 1961,                         /* -no-pie */
  OPT_nocpp = 1962,                          /* -nocpp */
  OPT_nodefaultlibs = 1963,                  /* -nodefaultlibs */
  OPT_nolibc = 1964,                         /* -nolibc */
  OPT_nophoboslib = 1965,                    /* -nophoboslib */
  OPT_nostartfiles = 1966,                   /* -nostartfiles */
  OPT_nostdinc = 1967,                       /* -nostdinc */
  OPT_nostdinc__ = 1968,                     /* -nostdinc++ */
  OPT_nostdlib = 1969,                       /* -nostdlib */
  OPT_o = 1970,                              /* -o */
  OPT_objects = 1971,                        /* -objects */
  OPT_p = 1972,                              /* -p */
  OPT_pass_exit_codes = 1973,                /* -pass-exit-codes */
  /* OPT_pedantic = 1974, */                 /* -pedantic */
  OPT_pedantic_errors = 1975,                /* -pedantic-errors */
  OPT_pg = 1976,                             /* -pg */
  OPT_pie = 1977,                            /* -pie */
  OPT_pipe = 1978,                           /* -pipe */
  OPT_posix = 1979,                          /* -posix */
  OPT_print_file_name_ = 1980,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1981,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1982,          /* -print-multi-directory */
  OPT_print_multi_lib = 1983,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1984,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1985,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1986,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1987,               /* -print-prog-name= */
  OPT_print_search_dirs = 1988,              /* -print-search-dirs */
  OPT_print_sysroot = 1989,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1990,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1991,                    /* -print-value */
  OPT_profile = 1992,                        /* -profile */
  OPT_pthread = 1993,                        /* -pthread */
  OPT_quiet = 1994,                          /* -quiet */
  OPT_r = 1995,                              /* -r */
  OPT_rdynamic = 1996,                       /* -rdynamic */
  ...
  OPT_time = 2082,                           /* -time */
  OPT_time_ = 2083,                          /* -time= */
  OPT_tno_android_cc = 2084,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2085,                 /* -tno-android-ld */
